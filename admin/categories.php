...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($data['errors'] === false) {
        ...
        $query = "INSERT INTO `categories`( `category`,`category_image`) 
            VALUES ('$_POST[category]','$name') ";
                    ...
                    <tbody>
                        ...
                        ?>
                                <tr>
                                    ...
                                    <td><img src="./images/categories/<?php echo $row['category_image'] ?>" height="50px" alt=""></td>
                                    <td>
                                        <div class="dropdown">
