...
<head>
    ...
    <title>Edit Category - MK fFashion</title>
        ...
        <div class="container mt-3 bg-white p-4">
            ...
            <div class="row">
                ...
                <div class="col-md-6 d-flex justify-content-end">
                    <img src="./images/categories/<?= $row['category_image'] ?>" class="" height="50px">
                </div>
            </div>
            <hr>
            ...
            <form action="./category-update-qry.php" method="POST" enctype="multipart/form-data" class="row">
                ...
                <div class="col-lg-4">
                    ...
                    <input type="hidden" class="form-control" value="<?= $row['category_image'] ?>" name="old_image" accept="image/*" required>
                </div>
